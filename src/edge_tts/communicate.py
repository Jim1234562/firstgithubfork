...
def mkssml(tc: TTSConfig, escaped_text: Union[str, bytes]) -> str:
    ...
    return (
        ...
        f'<voice name="en-US-DavisNeural"><mstts:express-as style="unfriendly">"<prosody contour="(4%, -1%) (49%, +0%) (76%, +49%) (83%, -27%)">I needed to make certain</prosody><prosody contour="(63%, -5%) (76%, +54%) (85%, -4%)"> you didn't attempt to harm me.</prosody>"</mstts:express-as></voice>'
        "</voice>"
        "</speak>"  
    )
